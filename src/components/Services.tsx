...
const services: { title: string; description: string; icon: LucideIcon }[] = [
  // KORRIGIERTER EINTRAG: 'Window' wurde durch 'Frame' ersetzt.
  {
    ...
    description:
      "Komplettservice für Fenster: Von der Beratung bis zum fachgerechten Einbau.",
    icon: Frame,
  },
  {
    title: "Gartenpflege & Außenanlagen",
    description:
      "Pflege von Gärten, Heckenschnitt und Winterdienst für Gewerbe- und Privatanlagen.",
    icon: Leaf,
  },
  {
    title: "Handwerkerarbeiten",
    description:
      "Kleinreparaturen im Haushalt, Montagearbeiten und schnelle Lösungen für jedes Problem.",
    icon: Hammer,
  },
  {
    title: "Gebäudereinigung",
    description:
      "Professionelle Reinigung für Privatwohnungen, Büros und Treppenhäuser.",
    icon: Sparkles,
  },
  {
  ...
  },
  {
    ...
    description:
      "Wir gestalten Räume neu – von Tapezierarbeiten bis zur Verlegung von Böden.",
    icon: Paintbrush,
  },
];
